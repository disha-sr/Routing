...
//    The method I have used is, everytime on a location change, the user's
//    new lat and long will be saved into Firebase, a routeName that the user
//    has set and (currently) a static routeId.
